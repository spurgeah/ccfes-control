...
# Shared parameters for stimulation (adjustable in real time)
params = {
    "amp1": 7, # mA, channel 1 amplitude
    "amp2": 7, # mA
    "freq1": 20,  # Hz
    "freq2": 20, # Hz
...
async def main():
    ...
    init_params.signal_type = [DyscomSignalType.BI, DyscomSignalType.EMG_1, DyscomSignalType.EMG_2, DyscomSignalType.BREATHING]
        # BI - bipolar input, EMG_1 and EMG_2 - EMG channels, BREATHING - breathing signal
        # 
