...
MVC_CH1_UV = 3 * 10**-5 # mV -> .004 µV
MVC_CH2_UV = 4 * 10**-7 # mV -> .004 µV
        ...
        while not stop_event.is_set():
            ...
            if ack and ack.command == Commands.DL_SEND_LIVE_DATA:
                ...
                if len(buffer_ch1) >= block_size:
                    ...
                    norm_ch1 = current_rms_ch1 / max(abs(MVC_CH1_UV), 1e-9)
                    norm_ch2 = current_rms_ch2 / max(abs(MVC_CH2_UV), 1e-9)
