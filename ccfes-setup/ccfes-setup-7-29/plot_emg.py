...
#csv_path = r"y:\Hasomed Code\HasomedSetup13\ScienceMode4Python\ccfes-setup\ccfes-setup-7-29\csv_files\8-12-4.csv"
...
csv_path = r"\\clusterfsnew.ceas1.uc.edu\students\spurgeah\My Documents\GitHub\ccfes-control\ccfes-setup\ccfes-setup-7-29\csv_files\12-11-3.csv"
...
plt.title("EMG Readingsvs Total Runtime")
plt.legend()
plt.tight_layout()
plt.show()