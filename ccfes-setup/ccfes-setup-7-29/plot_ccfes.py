...
emg1_idx = header.index("EMG_CH2") 
emg2_idx = header.index("EMG_CH3")
emg3_idx = header.index("stim_amp1") 
emg4_idx = header.index("stim_amp2")
...
plt.plot( emg_ch1, label="EMG 1, CH2")
plt.plot( emg_ch2, label="EMG 2, CH3")
plt.plot( emg_ch3, label="Stim Amp 1")
plt.plot( emg_ch4, label="Stim Amp 2")
plt.xlabel("Total Runtime (packets)")
plt.ylabel("EMG Value")
plt.title("EMG Readings vs Total Runtime")
plt.legend()
plt.tight_layout()
plt.show()